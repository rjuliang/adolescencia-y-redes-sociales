    ...
    render(){
        return (
            <div>
                ...
                <br></br>
                <figure>
                    <img src={graph_1} alt="En Colombia hay 8.5 millones de personas entre los 10 y los 19 años de edad: 49% mujeres y 51% hombres"/>
                </figure>
                <br></br>
                ...
                <figure>
                    <img src={ansiedad_depresion_img} alt="27% Ansiedad y 15% depresion (graficas de porcentages)"/>
                </figure>
                <br></br>
